...
if __name__ == "__main__":
    ...
    # ---------------- 1. 自动侦测真实数据维度 ----------------
    file_path = "E:/jbgs-model-training-main(5)/vae/geo/static_latents.pt"
    try:
    ...
    # ---------------- 2. 模拟组件初始化 ----------------
    # 🌟 修改 2：对齐全局真实的物理网格尺寸 40x40x10 (注意 n_theta 改为 40)
    nz_orig, n_theta_orig, n_R_orig = 40, 40, 10
    # 🌟 修改 3：对齐压缩后的潜空间网格尺寸 20x20x5 (基于 [2,2,2] 压缩比)
    nz_lat, n_theta_lat, n_R_lat = 20, 20, 5
    Ld_lat = nz_lat * n_theta_lat * n_R_lat
